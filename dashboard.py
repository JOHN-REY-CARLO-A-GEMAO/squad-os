...
def load_missions():
    ...
    Optimization: Removed pandas dependency to reduce import overhead (~0.8s)
    and memory usage (~50MB+) during Streamlit's 5-second auto-refresh cycles.
    """
    ...
    if conn:
        try:
            ...
            conn.close()
            # Returns a list of dict-like sqlite3.Row objects (cast to dict for safety)
