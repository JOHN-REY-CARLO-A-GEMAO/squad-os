...
def list_projects():
    """Returns lists of active and archived project names, optimized with os.scandir."""
    # os.scandir is O(N) vs os.listdir O(2N) because it avoids separate stat calls for is_dir()
