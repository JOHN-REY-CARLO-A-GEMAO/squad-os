...
def load_missions():
    ...
    if conn:
        try:
            ...
            conn.close()
            # Convert sqlite3.Row results to a list of dicts for lightweight handling
...
if not selected_project:
    ...
    @st.fragment
    def _render_chat():
        # Optimization: Replaced pandas DataFrame with a list of dictionaries to reduce memory footprint.
        ...
        with chat_container:
            if selected_id is not None:
                # Use a generator to find the mission in the list, avoiding O(N) indexing overhead.
