    ...
    with main_tab2:
        ...
        with col_b:
            ...
            with st.form("new_agent_form"):
                ...
                submit_agent = st.form_submit_button("💾 Save Persona", help="Save this agent persona to the registry.")
                if submit_agent:
                        ...
                        with cols[1]:
                            ...
                            if install_status == "ACTIVE":
                                ...
                                if sqad_path and sqad_path.startswith("http"):
                                    ...
                                    if st.button(f"⬇️ Install", key=f"install_{pkg['id']}", use_container_width=True, help=f"Install {pkg['name']} from the local filesystem."):
        ...
        with store_tab3:
            ...
            if uploaded_sqad:
                ...
                if pkg:
                    ...
                    if st.button("💾 Install this package", use_container_width=True, type="primary", help="Proceed with installing the validated package."):
