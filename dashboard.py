...
def list_projects():
    """Returns a list of active and archived projects using os.scandir for efficiency."""
...
if not selected_project:
    ...
    with tab1:
        ...
        if os.path.exists(visuals_path):
            ...
            # Using os.scandir to reduce system calls during visual artifact filtering
