    ...
    with main_tab2:
        ...
        with col_b:
            ...
            with st.form("new_agent_form"):
                ...
                submit_agent = st.form_submit_button("💾 Save Persona", help="Save this agent persona to the registry for use in missions")
                if submit_agent:
                        ...
                        with cols[1]:
                            ...
                            if install_status == "ACTIVE":
                                ...
                                if sqad_path and sqad_path.startswith("http"):
                                    ...
                                    if st.button(f"⬇️ Install", key=f"install_{pkg['id']}", use_container_width=True, help=f"Install {pkg['name']} to your Agent Store"):
                        ...
                        if i + j < len(registry_pkgs):
                            ...
                            with cols[j].container(border=True):
                                ...
                                if st.button(
                                    ...
                                    help=f"Download and install {pkg['name']} from the community registry"
                                ):
        ...
        with store_tab3:
            ...
            if uploaded_sqad:
                ...
                if pkg:
                    ...
                    if st.button("💾 Install this package", use_container_width=True, type="primary", help="Finalize installation of the uploaded .sqad package"):
